...
Para melhor experiência e aproveitamento visual do sistema, recomenda-se que o projeto seja compilado e executado diretamente no Terminal. Para isso, execute os comandos abaixo:
